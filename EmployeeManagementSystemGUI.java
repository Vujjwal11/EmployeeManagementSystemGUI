...
public class EmployeeManagementSystemGUI {
    ...
    public void viewEmployee() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            JLabel deptnoLabel = new JLabel("Department No.");
            deptnoLabel.setFont(new Font("Times New Roman", Font.PLAIN, 20));

            JLabel deptnoVal = new JLabel(resultSet.getString(3));
            deptnoVal.setFont(new Font("Times New Roman", Font.PLAIN, 20));

            JLabel designationLabel = new JLabel("Designation");
            designationLabel.setFont(new Font("Times New Roman", Font.PLAIN, 20));

            JLabel designationVal = new JLabel(resultSet.getString(4));
            ...
            JLabel salaryVal = new JLabel(String.valueOf(resultSet.getDouble(5)));
            ...
            employeeCard.add(deptnoLabel);
            employeeCard.add(deptnoVal);
    ...
    public void addEmployee() throws SQLException  {
        ...
        JLabel deptnoLabel = new JLabel("Enter Department No.");
        deptnoLabel.setFont(new Font("Times New Roman", Font.PLAIN, 20));

        JTextField deptnoVal = new JTextField("");
        deptnoVal.setFont(new Font("Times New Roman", Font.PLAIN, 20));
        ...
        submitButton.addActionListener(actionListener -> {
            ...
            String deptno = deptnoVal.getText();
            String designation = designationVal.getText();
            double salary = Double.parseDouble(salaryVal.getText());

            String q = String.format("insert into employee values (%d, '%s', '%s', '%s', %f);", id, name,
    ...
    public void editEmployeeHelper(int id, JFrame parentFrame) throws SQLException {
        ...
        JTextField deptnoVal = new JTextField(resultSet.getString(3));
        deptnoVal.setFont(new Font("Times New Roman", Font.PLAIN, 20));

        JLabel designationLabel = new JLabel("Designation");
        designationLabel.setFont(new Font("Times New Roman", Font.PLAIN, 20));

        JTextField designationVal = new JTextField(resultSet.getString(4));
        designationVal.setFont(new Font("Times New Roman", Font.PLAIN, 20));

        JLabel salaryLabel = new JLabel("Salary");
        salaryLabel.setFont(new Font("Times New Roman", Font.PLAIN, 20));

        JTextField salaryVal = new JTextField(String.valueOf(resultSet.getDouble(5)));
        salaryVal.setFont(new Font("Times New Roman", Font.PLAIN, 20));
        ...
        submitButton.addActionListener(actionListener -> {
            ...
            String query = String.format("update employee set name = '%s', deptno = '%s', " +
                            "designation = '%s', salary = %s where id = %d;", name, 
                    deptno, designation, salary, id);
            try {
